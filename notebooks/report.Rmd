...
```{r corr plot, warning=FALSE, message = FALSE, echo = FALSE, fig.cap='Correlation matrix of model variables', fig.height = 3}
...
```{r causal plot, warning=FALSE, message = FALSE, echo = FALSE, fig.cap='Causal diagram with omitted variables', fig.height = 3}
dag_plot
```
